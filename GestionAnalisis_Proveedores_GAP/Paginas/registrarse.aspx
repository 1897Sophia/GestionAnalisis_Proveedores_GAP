<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="registrarse.aspx.vb" Inherits="GestionAnalisis_Proveedores_GAP.registrarse" EnableEventValidation="false" ValidateRequest="false" %>
    ...
    <body>
        ...
        <div class="vh-100 d-flex justify-content-center align-items-center">
            <div class="col-md-4 p-5 shadow-sm border rounded-5 border-primary">
                ...
                <div class="mt-3">
                    <p class="mb-0  text-center"> <a href="signup.html"
                            class="text-primary fw-bold">Iniciar Sesión</a></p>
                </div>
            </div>
        </div>
    </body>
